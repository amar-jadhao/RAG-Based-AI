...
Convert all the video files to mp3 by ruunning video_to_mp3 in audios folder

## Step 3 - Convert mp3 to json 
Convert all the mp3 files to json by ruunning mp3_to_json. After .json's are done for more optimization you can run merge_chunks.py
